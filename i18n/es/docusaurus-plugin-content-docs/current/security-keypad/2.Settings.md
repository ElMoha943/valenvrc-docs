...
![Configuración de KeyPad](img/security_keypad/settings.png)
...
![Lista de Roles de KeyPad](img/security_keypad/roles_list.png)
...
![Configuración de Seguridad de KeyPad](img/security_keypad/security_settings.png)
