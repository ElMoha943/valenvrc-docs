...
![KeyPad Settings](/img/docs/security-keypad/settings.png)
...
![KeyPad Roles list](/img/docs/security-keypad/roles_list.png)
...
![KeyPad Security Settings](/img/docs/security-keypad/security_settings.png)
