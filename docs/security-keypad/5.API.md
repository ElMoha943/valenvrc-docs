...
**Implicit Roles:**
Tags given because you have been explicitly asigned to one of its parents. For example, if you have the VIP+ role asigned and said role has VIP as a child role, you will be given the VIP implicit tag.

These 2 lists combine into a single **Roles** list which is syncronized to remote users. This division its used internally to determine if you need to be logged out of a role, and can also be used by external systems to perform all kinds of checks depending on your needs.
