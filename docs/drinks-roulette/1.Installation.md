...
- Cooldown : float - Time in seconds to wait betwen spins.
- WheelSets : WheelSet[] - List of available *WheelSets* (prompt packs) to use.

### References

You sohuldnt need to touch these unless you know exactly what you are doing.
...
:::note
The roullette bottle always spins the same amount and lands on the same place, its not meant to be used as a player seleciton, see [variables](./wheel-sets#variables) for a proper way to randomly select a player for prompts.
:::
