...
---
The notification system is used to log and display actions to the user. It is important to leave it enabled in order to comply with the [Moderation Tool Guidelines](https://hello.vrchat.com/creator-guidelines).
