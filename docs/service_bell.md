...
:::warning
The service bell does not include a role managment system, it was designed to work along third party systems like the **[BouncerSystem](./category/bouncersystem)** or **[SecurityKeypad](./category/security-keypad)**.
:::

### Settings

- RingCooldown : float - Time in seconds betwen bell rangs, global, shared by all users.
